...
-- IMPORTANT: This query now returns ALL orders (both with and without unapproved abbreviations)
-- For orders without issues, the Flagged, FlaggedInDose, and FlaggedInLabel columns will be NULL
-- This allows accurate calculation of percentages: (orders with abbreviation / total orders) * 100
